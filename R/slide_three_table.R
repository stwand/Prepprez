...
#' @export
#'
slide_three_table <- function(deck
                            ,tab1
                            ,tab2
                            ,tab3
                            ,sld_loy
  ...
  deck <- deck |>
    ...
    officer::ph_with(value = tab3, location = officer::ph_location_label(ph_label = "tab3"))
  deck
}
